...
/**
 * To retrieve all products information, we need Admin Bearer token.
 */
public class ListAllProducts {
    public static void main(String[] args) throws Exception{
        ...
        HttpResponse<JsonNode> res = Unirest.get("https://api.keygen.sh/v1/accounts/"+ account_id + "/products")
